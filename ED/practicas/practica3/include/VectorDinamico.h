...
/**
  ...
  * dos enteros, uno con el número de elementos almacenados y otro con la capacidad
...
template <class T>
  ...
  private:
    ...
    /**
      * @page repVectorDinamico Rep del T.D.A VectorDinamico
      *
  ...
  public:
    ...
    void insert(const int i,const T& val);
