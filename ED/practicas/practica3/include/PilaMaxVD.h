/**
  * @file PilaMaxVD.h
  * @brief Fichero cabecera del T.D.A mstack (PilaMaxVD) usando el T.D.A VectorDinamico
  *
  */
...
/**
  ...
  * un VectorDinamico de parejas que almacenan un valor y el máximo cuando se introdujo dicho valor
  *
...
class mstack{
  private:
    ...
    VectorDinamico<pair> vector;    /**< VectorDinamico que simula la utilización de una pila */
