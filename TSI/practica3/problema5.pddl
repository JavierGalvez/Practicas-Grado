(define (problem ejer5)
    (:domain starcraft)
    (:objects
        vce1 vce2 vce3 segador1 marine1 marine2 - Unidad
        centroDeMando1 centroDeMando2 barracones1 extractor1 bahia1 - Edificio
    ...
    (:init
        ...
        (necesita Impulsor_Segador Mineral) 
        (necesita Impulsor_Segador Gas) 
