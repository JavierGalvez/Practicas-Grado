(define (problem ejer7)
    (:domain starcraft)
    (:objects
        vce1 vce2 vce3 segador1 marine1 marine2 - Unidad
        centroDeMando1 barracones1 extractor1 bahia1 deposito1 deposito2 - Edificio
    ...
    (:init
        ...
        (tipoEdificio bahia1 Bahia_de_Ingenieria)
        (tipoEdificio deposito1 Deposito)
        (tipoEdificio deposito2 Deposito)
        ...
        (= (recursoDisponible Mineral) 100)
        (= (recursoDisponible Gas) 100)
        (= (maxCapacidad) 100)
        (= (vceExtrayendo Mineral) 0)
        (= (vceExtrayendo Gas) 0)
        (= (cantidadRecolectada) 25)

        (= (necesita Barracones Mineral) 150)
        (= (necesita Barracones Gas) 0)
        (= (necesita CentroDeMando Mineral) 150)
        (= (necesita CentroDeMando Gas) 50)
        (= (necesita Extractor Mineral) 75)
        (= (necesita Extractor Gas) 0)
        (= (necesita Bahia_De_Ingenieria Mineral) 125)
        (= (necesita Bahia_De_Ingenieria Gas) 0)
        (= (necesita Deposito Mineral) 75)
        (= (necesita Deposito Gas) 25)

        (= (necesita VCE Mineral) 50)
        (= (necesita VCE Gas) 0)
        (= (necesita Marine Mineral) 50)
        (= (necesita Marine Gas) 0)
        (= (necesita Segador Mineral) 50)
        (= (necesita Segador Gas) 50)

        (= (necesita Impulsor_Segador Mineral) 50)
        (= (necesita Impulsor_Segador Gas) 200)

        (= (tiempo CentroDeMando) 100)
        (= (tiempo Barracones) 46)
        (= (tiempo Extractor) 21)
        (= (tiempo Bahia_De_Ingenieria) 25)
        (= (tiempo Deposito) 21)
        (= (tiempo VCE) 12)
        (= (tiempo Marine) 18)
        (= (tiempo Segador) 32)
        (= (tiempo Impulsor_Segador) 120)
        ...
        (necesitaInvestigacion Segador Impulsor_Segador)
    )
    (:goal
        (and
